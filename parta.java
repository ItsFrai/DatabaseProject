...
public class parta {
    public static void searchStudentsByName(String searchString, String dbUrl, String username, String password) {
        try {
            ...
            // set the parameter values in the query statement
            stmt.setString(1, "%" + searchString.toLowerCase() + "%");
            stmt.setString(2, "%" + searchString.toLowerCase() + "%");
